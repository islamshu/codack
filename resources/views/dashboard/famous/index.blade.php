...
<div class="row">
    ...
    <div class="col-2 p-0 ms-auto flex-column flex-center justify-content-between p-4">
      <a class="btn btn-primary  btn-lg w-100" data-bs-toggle="modal" data-bs-target="#addFamous">
  ...
  <div class="filters mt-3">
    <form >
      <div class="d-flex">
        ...
        <div class="flex-basis-20 pe-3 d-flex flex-column">
          <label class="flex-fill" for="">الدولة</label>
          <div class="input-group input-group-lg flex-fill">
        ...
        <div class="flex-basis-20 align-items-end d-flex">
          <span class="p-2 border rounded-3">
            <button class="btn"> <img src="{{asset('new_dash/images/icons/filters.png')}}" alt="" /></button>
        ...
        <table id="example" class="display compact" style="width:100%" id="storestable">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-right">عدد الاكواد </th>
            ...
            <tbody id="stores">
                @foreach ($famous as $key => $item)
                    <tr>
                        ...
                        <td class="text-right">{{ App\Models\Code::where('famous_id',$item->id)->count() }} </td>

                        <td class="text-right">
                            @if(auth()->user()->hasRole('Admin'))
                            
                            <a href="{{ route('famous.edit', $item->id) }}" class="btn "><img src="{{asset('new_dash/images/icons/edit.png')}}" class="pointer"
                                alt=""></a>
                                <form style="display: inline" action="{{ route('famous.destroy',$item->id) }}" method="post">
                                    @method('delete') @csrf
