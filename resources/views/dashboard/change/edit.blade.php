                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> تعديل بيانات البنك</h4>
                                    ...
                                    <h4 class="form-section"><i class="la la-add"></i>بيانات البنك الحالية   </h4>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" required value="{{@ $change->famous->bank->bank_name }}" readonly id="email">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="email">   الاسم بالبنك الحالي  :</label>
                                                <input type="text" class="form-control" required value="{{@ $change->famous->bank->account_name }}" readonly id="email">
                                            </div>
                                        </div>
                                    </div>
